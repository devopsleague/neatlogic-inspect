...
CREATE TABLE IF NOT EXISTS `inspect_accessendpoint_script`  (
  ...
  `config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '拓展配置',
  PRIMARY KEY (`resource_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '资产清单的脚本关联表';
...
CREATE TABLE IF NOT EXISTS `inspect_alert_everyday`  (
  ...
  `alert_rule` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '告警规则',
  `alert_tips` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '告警提示',
...
CREATE TABLE IF NOT EXISTS `inspect_appsystem_schedule`  (
  ...
  UNIQUE INDEX `idx_app_system_id`(`app_system_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时巡检';
...
CREATE TABLE IF NOT EXISTS `inspect_ci_combop`  (
  ...
  `combop_id` bigint NULL DEFAULT NULL COMMENT '组合工具id',
  PRIMARY KEY (`ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '巡检配置组合';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '巡检资源配置文件记录';
...
CREATE TABLE IF NOT EXISTS `inspect_config_file_last_change_time`  (
  ...
  PRIMARY KEY (`resource_id`) USING BTREE,
  INDEX `idx_last_change_time`(`last_change_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '巡检资产最近变更时间';
...
CREATE TABLE IF NOT EXISTS `inspect_config_file_path`  (
  ...
  `md5` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '最新配置文件MD5',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '巡检资源配置文件路径';
...
CREATE TABLE IF NOT EXISTS `inspect_config_file_version`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_record_id`(`audit_id`) USING BTREE,
  INDEX `idx_path_id`(`path_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '巡检资源配置文件版本';
...
CREATE TABLE IF NOT EXISTS `inspect_new_problem_customview`  (
  ...
  `condition_config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '搜索条件配置',
  `sort` int NOT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_name_user`(`name`, `user_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '巡检报告个人视图';
...
CREATE TABLE IF NOT EXISTS `inspect_schedule`  (
  ...
  `lcu` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_ci_id`(`ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时巡检';